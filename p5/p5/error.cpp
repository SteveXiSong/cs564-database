...
void Error::print(Status status)
{
  ...
  switch(status) {
    ...
    case ATTRTOOLONG:  cerr << "attributes too long"; break; // added error information
    case RELTOOLARGE:   cerr << "relation too large"; break;
    ...
    case ATTRNULL:     cerr << "insert null attribute"; break; // added error information
